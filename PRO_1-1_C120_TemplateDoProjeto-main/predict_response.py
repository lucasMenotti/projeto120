...
intents = json.loads(open('PRO_1-1_C120_TemplateDoProjeto-main/intents.json').read())
words = pickle.load(open('PRO_1-1_C120_TemplateDoProjeto-main/words.pkl','rb'))
classes = pickle.load(open('PRO_1-1_C120_TemplateDoProjeto-main/classes.pkl','rb'))
...
def preprocess_user_input(user_input):
    ...
    input_word_token_2 = get_stem_words(input_word_token_1, input_word_token_2)
